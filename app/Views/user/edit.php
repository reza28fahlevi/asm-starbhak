      ...
      <div class="card-body">
        ...
        <form method="post" action="<?= base_url('user/update/' . $user['id']) ?>">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" name="nama" class="form-control" id="nama" required value="<?= old('nama', $user['nama']) ?>">
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" name="nohp" class="form-control" id="nohp" value="<?= old('nohp', $user['nohp']) ?>">
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" name="nomor_registrasi" class="form-control" id="nomor_registrasi" value="<?= old('nomor_registrasi', $user['nomor_registrasi']) ?>">
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select name="departemen_id" class="form-select" id="departemen_id">
                ...
                <option value="1" <?= old('departemen_id', $user['departemen_id']) == '1' ? 'selected' : '' ?>>IT</option>
                <option value="2" <?= old('departemen_id', $user['departemen_id']) == '2' ? 'selected' : '' ?>>Finance</option>
                <option value="3" <?= old('departemen_id', $user['departemen_id']) == '3' ? 'selected' : '' ?>>HR</option>
                <option value="4" <?= old('departemen_id', $user['departemen_id']) == '4' ? 'selected' : '' ?>>Operations</option>
              </select>
            </div>
          </div>
